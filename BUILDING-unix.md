...
matcher, and the session dropping mid-edit). 230 cases in all.
...
- `/bin/sh` being dash
- All 230 tests, and the same again under both sanitizers
...
- All 230 tests, and `-DTERMCAP` against base curses (found as `-lcurses`),
  with no warnings
