...
the `:!` filter and wildcard expansion), `scripts/test-syntax.sh` (49 cases
...
rather than the rules). 176 cases in all.
...
- `/bin/sh` being dash
- All 176 tests, and the same again under AddressSanitizer
