...
the `:!` filter and wildcard expansion), `scripts/test-syntax.sh` (44 cases
...
rather than the rules). 163 cases in all.
...
- `/bin/sh` being dash
- All 163 tests, and the same again under AddressSanitizer
