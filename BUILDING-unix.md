...
the `:!` filter and wildcard expansion), `scripts/test-syntax.sh` (39 cases
...
rather than the rules). 158 cases in all.
...
- `/bin/sh` being dash
- All 158 tests, and the same again under AddressSanitizer
