...
./scripts/build-unix.sh test     # ビルドしてテスト 152 ケースを実行
...
./scripts/test-syntax.sh   src/jvim3   # 37 ケース
./scripts/test-sgr.sh      src/jvim3   # 3 ケース
```
...
ではなく描画側を見る唯一のスイートです。合わせて 152 ケースです。
