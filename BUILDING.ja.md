...
./scripts/build-unix.sh test     # ビルドしてテスト 227 ケースを実行
...
./scripts/test-encoding.sh src/jvim3   # 50 ケース
...
- Linux (Ubuntu 24.04 / gcc)、FreeBSD (clang)、NetBSD、OpenBSD、DragonFly で
  227 テスト全件通過。Linux では AddressSanitizer と
