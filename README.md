...
Tests            255 cases, run on all of the above in CI, plus 6 that run
...
cd jvim3
./scripts/build-unix.sh test        # build src/jvim3, then run the 255 tests
...
./scripts/test-editing.sh  src/jvim3   # 89 cases: motions, operators, registers,
