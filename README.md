...
Tests            219 cases, run on all of the above in CI. The Windows
...
cd jvim3
./scripts/build-unix.sh test        # build src/jvim3, then run the 219 tests
```
...
Every push and pull request builds and runs all 219 on Linux, FreeBSD, NetBSD,
