...
Tests            282 cases, run on all of the above in CI, plus 6 that run
...
cd jvim3
./scripts/build-unix.sh test        # build src/jvim3, then run the 282 tests
...
./scripts/test-editing.sh  src/jvim3   # 116 cases: motions, operators, registers,
