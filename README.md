...
Tests            223 cases, run on all of the above in CI. The Windows
...
cd jvim3
./scripts/build-unix.sh test        # build src/jvim3, then run the 223 tests
```
...
Every push and pull request builds and runs all 223 on Linux, FreeBSD, NetBSD,
