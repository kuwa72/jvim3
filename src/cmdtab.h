...
#define CMD_syntax 145
	{(char_u *)"@",				RANGE+EXTRA+TRLBAR},
#define CMD_at 146
	{(char_u *)"!",				RANGE+NAMEDFS},
#define CMD_bang 147
	{(char_u *)"<",				RANGE+COUNT+TRLBAR},
#define CMD_lshift 148
	{(char_u *)">",				RANGE+COUNT+TRLBAR},
#define CMD_rshift 149
	{(char_u *)"=",				RANGE+TRLBAR},
#define CMD_equal 150
	{(char_u *)"&",				RANGE+EXTRA},
#define CMD_and 151
	{(char_u *)"~",				RANGE+EXTRA}
#define CMD_tilde 152
#define CMD_SIZE 153
