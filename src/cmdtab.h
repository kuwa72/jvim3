...
#define CMD_make 69
	{(char_u *)"macros",		TRLBAR},
#define CMD_macros 70
	{(char_u *)"mkexrc",		BANG+FILE1+TRLBAR},
#define CMD_mkexrc 71
	{(char_u *)"mkvimrc",		BANG+FILE1+TRLBAR},
#define CMD_mkvimrc 72
	{(char_u *)"mfstat",		TRLBAR},				/* for debugging */
#define CMD_mfstat 73
...
#define CMD_syntax 147
	{(char_u *)"@",				RANGE+EXTRA+TRLBAR},
#define CMD_at 148
	{(char_u *)"!",				RANGE+NAMEDFS},
#define CMD_bang 149
	{(char_u *)"<",				RANGE+COUNT+TRLBAR},
#define CMD_lshift 150
	{(char_u *)">",				RANGE+COUNT+TRLBAR},
#define CMD_rshift 151
	{(char_u *)"=",				RANGE+TRLBAR},
#define CMD_equal 152
	{(char_u *)"&",				RANGE+EXTRA},
#define CMD_and 153
	{(char_u *)"~",				RANGE+EXTRA}
#define CMD_tilde 154
#define CMD_SIZE 155
